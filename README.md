...
<div style="display: flex; flex-wrap: wrap;"><img src="combined_qr.png" alt="combined_qr.png" style="width:185px; height:185px; margin-right: 10px; margin-bottom: 10px;" /></div></br>
</br>
